{
    ...
    T1->SetTitle("tr16001001130.hld;column;row");can_1->SetLogz();
    ...
    T3->SetTitle("tr16001001130.hld;column;row");can_2->SetLogz();
    ...
    T4->SetTitle("tr16001001130.hld;column;row");can_3->SetLogz();
    T4->GetZaxis()->SetRangeUser(0,10000);
    can->cd(4);T->Draw("event.multH1>>mT1(120,0,120)");can_4->SetLogy();can_4->SetLogx();
    mT1->SetTitle("tr16001001130.hld;hit multiplicity;events");mT1->SetFillColor(5);
    ...
    mT3->SetTitle("tr16001001130.hld;hit multiplicity;events");mT3->SetFillColor(5);
    ...
    mT4->SetTitle("tr16001001130.hld;hit multiplicity;events");mT4->SetFillColor(5);
    //mT4->GetXaxis()->SetRangeUser(0.1,250);
    mT4->GetYaxis()->SetRangeUser(1,300000);
    can->SaveAs("png/16001/tr16001001130.hld.png");
    can->SaveAs("tmpShow.pdf");
    ofstream fs("png/16001/rate/tr16001001130.hld.dat");
    fs << "#T1" << endl;
    ...
    fs.close();
    ofstream fs2("png/16001/rate/tr16001001130.hld.dat");
    fs2 << "#T1" << endl;
